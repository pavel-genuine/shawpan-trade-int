    ...
    return (
        <div className="bg-bg lg:h-[80vh] h-[40vh] ">
            <div class="relative ">
                ...
                <div class="absolute lg:top-10 lg:left-[15vw] top-6">
                    <motion.div
                        viewport={{ once: true }}
                        ...
                        <video className=' rounded lg:h-[70vh] lg:w-[70vw] h-[25vh] w-[90vw] ' src={'https://www.mgtstoneco.com/wp/wp-content/uploads/2022/02/royal-black-marble.mp4'} autoPlay loop muted></video>
                        <div>
