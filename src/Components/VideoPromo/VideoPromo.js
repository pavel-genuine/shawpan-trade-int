...
const VideoPromo = () => {
    return (
        <div className="bg-[grey] lg:h-[90vh] h-[40vh] ">
            <div class="relative ">
                ...
                <div class="absolute lg:top-14 top-8">
                    <motion.div
                        viewport={{ once: true }}
                        ...
                        <video className=' rounded border-2  lg:h-8/12 lg:w-8/12 w-11/12 h-11/12 lg:ml-24 ' src={'https://www.mgtstoneco.com/wp/wp-content/uploads/2022/02/royal-black-marble.mp4'} autoPlay loop muted></video>
                        <div>
