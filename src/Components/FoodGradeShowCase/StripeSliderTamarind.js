...
export const persons = [
    ...
    {
        img:'https://vaya.in/recipes/wp-content/uploads/2018/11/Tamarind-seeds.jpg',
        title: "Fresh Tamarind Seed",
        name: "Amazing Quality",
    },
    {
...
export default StripeSliderTamarind
