    ...
    return (
        <div className='w-[100vw] absolute' style={{ zIndex: 100 }}>
            ...
            <div id='' style={{ transition: "all .5s", }} className=
                {`${toggleOpen?'':'overflow-hidden'} nav w-[100vw]  h-[60px] md:h-[80px]  fixed  ${!background ? 'bg-opacity-0 bg-white' : 'bg-opacity-40 bg-[black] backdrop-blur-md'} `}
            >
